...
// when you need them. 
////////////////////////////////////////////////////////////////////////////////
#define AFIO_EXTICR2 ((volatile uint16_t *)0x4001000C)
#define EXTI_BASE 0x40010400
#define EXTI_INTENR ((volatile uint32_t *)(EXTI_BASE))
#define EXTI_RTENR ((volatile uint32_t *)(EXTI_BASE + 0x08))
#define EXTI_FTENR ((volatile uint32_t *)(EXTI_BASE + 0xC))
#define EXTI_INTFR ((volatile uint32_t *)(EXTI_BASE + 0x14))
#define EXTI7_IRQ_NUM 39
#define PFIC_IENR ((volatile uint32_t *) 0xE000E100)
...
{    
    ...
    // <your code here>
    // 1000 = 8
    GPIO_E->CFGLR = 0x88888888;
    GPIO_E->OUTDR = 0xFF; // all bits to 1.
    //GPIO_E->OUTDR = 0;
    ...
    // Configure AFIO to allow pin7 interrupts for port E
    *AFIO_EXTICR2 &= 0x0FFF; // Zero corresponding bits
    *AFIO_EXTICR2 |= 0x4000; // Set EXIT7 to 4 (Port E)
    ...
    //                76543210
    *EXTI_RTENR  |= 0b10000000; // Generate a pulse when pin7 goes from 0 to 1
    *EXTI_FTENR  |= 0b00000000; // Generate no pulse when pin7 goes from 1 to 0
    *EXTI_INTENR |= 0b10000000; // Enable interrupts only for pin 7
    ...
    ///////////////////////////////////////////////////////////////////////////
    PFIC_IENR[EXTI7_IRQ_NUM / 32] |= (1 << (EXTI7_IRQ_NUM % 32));
